...
def dashboard():
    ...
    return render_template("dashboard.html",user=User.get_by_id(data)) #then can pass in that information and pull the users information to display on the dashboard
